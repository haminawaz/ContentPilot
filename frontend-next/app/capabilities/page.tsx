  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <span
          aria-hidden
          className="absolute bottom-4 right-6 md:bottom-6 md:right-10 text-[90px] md:text-[140px] font-medium leading-none tracking-mc-tight text-ink-black/[0.04] select-none">
          0{index + 1}
        </span>
        ...
        <div
          ...
          <div className="mt-auto flex items-end justify-between pt-6 border-t border-ink-black/5">
            ...
            <div className="flex items-center gap-2 text-ink-black opacity-0 group-hover:opacity-100 translate-x-[-6px] group-hover:translate-x-0 transition-all duration-500">
...
export default function CapabilitiesPage() {
  return (
    <div className="min-h-screen bg-canvas-cream font-sans selection:bg-signal-orange selection:text-white">
      ...
      {/* HERO */}
      <main className="relative overflow-hidden pt-[140px] md:pt-[200px] pb-[80px] md:pb-[120px]">
        ...
        <div
          aria-hidden
          className="absolute right-[0vw] top-[32vh] w-[28vw] h-[28vw] border border-light-signal-orange/15 rounded-full pointer-events-none"
        />
        {/* soft halo */}
        <div
          aria-hidden
          className="absolute right-[-5vw] top-[20vh] w-[40vw] h-[40vw] bg-signal-orange/[0.08] rounded-full blur-[120px] pointer-events-none"
        />
        {/* dot grid */}
        <div
          aria-hidden
        ...
        <div className="px-6 md:px-[100px] max-w-7xl mx-auto relative z-10">
          ...
          <motion.h1
            ...
            className="text-[48px] sm:text-[64px] md:text-[84px] lg:text-[96px] mb-10 tracking-mc-tight leading-[0.95] font-medium text-ink-black max-w-[950px]">
                ...
                {word === "Rankings." ? (
                  <>
                    ...
                    <motion.span
                      ...
                      style={{ originX: 0 }}
                      className="absolute left-0 -bottom-2 h-[5px] w-full bg-signal-orange rounded-full"
                    />
                  </>
                ) : (
                  word
          ...
          <motion.p
            ...
            narrative. We don&apos;t just write — we engineer content around what
      ...
      {/* PROCESS GRID */}
      <section className="relative px-6 md:px-[100px] max-w-7xl mx-auto pb-[100px] md:pb-[160px]">
        <motion.div
      ...
      {/* CTA */}
      <section className="px-6 md:px-[100px] max-w-7xl mx-auto pb-[80px] md:pb-[140px]">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
