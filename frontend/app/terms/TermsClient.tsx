...
const sections: Section[] = [
  {
    ...
    body: (
      <p>
        Welcome to Structa. By accessing or using our platform, you agree
        to be bound by these Terms and Conditions. Structa is an
    ...
    body: (
      <ul className="space-y-3">
        <li>
          ...
          submit, as well as the content Structa generates from them.
        </li>
        <li>
        ...
        <li>
          While Structa strives to produce highly optimized and relevant
  ...
  },
  {
    ...
    body: (
      <p>
        The content generated by Structa from your submitted inputs
        ...
        remain the exclusive property of Structa and may not be copied,
  ...
  },
  {
    ...
    body: (
      <p>
        Structa does not guarantee any specific search engine ranking,
        ...
        we do not control. Structa is not liable for any direct,
    ...
    <div className="min-h-screen bg-canvas-cream font-sans text-ink-black selection:bg-signal-orange selection:text-white">
      ...
      <main className="relative overflow-hidden pt-35 md:pt-50 pb-20 md:pb-30">
        ...
        <div className="px-6 md:px-25 max-w-5xl mx-auto relative z-10">
          ...
          >
            The agreement between you and Structa when you use our
